...
import 'package:flutter/services.dart';
  ...
  class ColorService {
    ...
    static List<String> colors=["Primary Color","Secondary Color","Backround Color","Accent Color","Text Color","Dark Text Color","Subtitle Color"];
    static List<Color> baseColors=[Color(0xff0c52a1),Color(0xff1b71d3),Color(0xff444444),Color(0xff505050),Color(0xffffffff),Color(0xffdadada),Color(0xffa8a8a8)];
